...
void add_rank(user_stats *rating);
...
void add_rank(user_stats *rating){
    if (rating[0].rating < 19){
        strcpy(rating[0].rank, "Bronze");
    }
    else if (rating[0].rating < 39){
        strcpy(rating[0].rank, "Silver");
    }
    else if (rating[0].rating < 59){
        strcpy(rating[0].rank, "Gold");
    }
    else if (rating[0].rating < 79){
        strcpy(rating[0].rank, "Platinum");
    }
    else if (rating[0].rating <= 100){
        strcpy(rating[0].rank, "Diamond");
    }
     printf("%s", rating[0].rank);
}